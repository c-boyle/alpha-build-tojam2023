...
public partial class @ControlActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IDetectionActions> m_DetectionActionsCallbackInterfaces = new List<IDetectionActions>();
    ...
    public struct DetectionActions
    {
        ...
        public void AddCallbacks(IDetectionActions instance)
        {
            if (instance == null || m_Wrapper.m_DetectionActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_DetectionActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IDetectionActions instance)
        {
            @GamepadDetect.started -= instance.OnGamepadDetect;
            @GamepadDetect.performed -= instance.OnGamepadDetect;
            @GamepadDetect.canceled -= instance.OnGamepadDetect;
        ...
        public void RemoveCallbacks(IDetectionActions instance)
        {
            if (m_Wrapper.m_DetectionActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IDetectionActions instance)
        {
            foreach (var item in m_Wrapper.m_DetectionActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_DetectionActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
